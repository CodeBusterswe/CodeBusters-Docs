...
\begin{figure}[hb]
\includegraphics[width=17.5cm]{Images/Allegato Tecnico-Sequenza-DR}
\centering
...
\vspace*{\fill}
\begin{figure}[hb]
\includegraphics[width=19cm]{Images/Allegato Tecnico-Sequenza-PLMA}
\centering
\caption{Diagramma di sequenza che modella il processo per la visualizzazione delle preferenze e del grafico PLMA}
\end{figure}
\vfill
\end{landscape}
\newpage
...
\begin{figure}[hb]
\includegraphics[width=\linewidth ]{Images/Allegato Tecnico-Strategy}
\centering
