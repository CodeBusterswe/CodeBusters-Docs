...
R1F15.1 & OB & L'utente puó utilizzare l'algoritmo di riduzione dimensionale \glo{IsoMap} & UC3.1.1 + \textbf{interno?} \\
R1F15.2 & OB & L'utente puó utilizzare l'algoritmo di riduzione dimensionale \glo{LLE} & UC3.1.2 + \textbf{interno?}\\
R1F15.3 & OB & L'utente puó utilizzare l'algoritmo di riduzione dimensionale \glo{FastMap} & UC3.1.3 + \textbf{interno?}\\
R1F15.4 & OB & L'utente puó utilizzare l'algoritmo di riduzione dimensionale \glo{t-SNE} & UC3.1.4 + \textbf{interno?}\\
R3F15.4.1 & OP & L'utente può impostare la \glo{\textit{perplessità}} dell'algoritmo t-SNE & \\
R3F15.4.2 & OP & L'utente può impostare il tasso di apprendimento dell'algoritmo t-SNE & \\
R3F15.5 & OP & L'utente può impostare il numero di \glo{\textit{neighbors}} per la stima approssimativa del \glo{\textit{manifold}} & \\
...
R2F16.1 & DE & L'utente può calcolare le distanze tramite distanza di \glo{Manhattan} &  \\
R2F16.2 & DE & L'utente può calcolare le distanze tramite distanza di \glo{Canberra} &  \\
R2F16.3 & DE & L'utente può calcolare le distanze tramite distanza di \glo{Chebyshev} &  \\
