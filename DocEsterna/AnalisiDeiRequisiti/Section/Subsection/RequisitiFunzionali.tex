...
R F15.4.1 &  & L'utente può impostare la \glo{\textit{perplessità}} dell'algoritmo t-SNE & \\
R F15.4.2 &  & L'utente può impostare il tasso di apprendimento dell'algoritmo t-SNE & \\
R F15.5 &  & L'utente può impostare il numero di \glo{\textit{neighbors}} per la stima approssimativa del \glo{\textit{manifold}} & \\
