...
\multicolumn{4}{C{\total}}{\textbf{Piano di contingenza:} monitorare la quantità di lavoro svolta da ciascun componente ed aggiornare i valori per tutto l'avanzamento del progetto. In caso di variazioni consistenti è necessario comunicarle al \textit{proponente}. }\\
