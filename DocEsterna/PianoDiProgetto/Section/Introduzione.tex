...
Per evitare ambiguità relative alle terminologie utilizzare, è stato compilato il \Glossariov{2.0.0-0.2}. In questo documento sono riportati tutti i termini di particolare importanza e con un significato particolare. Questi termini sono evidenziati da una 'G' ad apice.
