...
\begin{figure}[!htb]
   \begin{minipage}{0.48\textwidth}
     \centering
     \includegraphics[width=1.3\linewidth]{Images/PO-Analisi}
     \caption{\parbox{10cm}{Ripartizione oraria per ciascun membro nella fase di Analisi}}
   \end{minipage}\hspace{3cm}
   \begin{minipage}{0.4\textwidth}
     \centering
     \includegraphics[width=.7\linewidth]{Images/PE-Analisi}
     \caption{\parbox{4.5cm}{Ripartizione ore totali nella fase di Analisi}}
   \end{minipage}
\end{figure}