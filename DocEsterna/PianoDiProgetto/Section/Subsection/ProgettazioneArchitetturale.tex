...
\begin{itemize}
	...
	\item \textbf{Incremento 1}: questo periodo, che va dal 18/02/2020 26/02/2020, è dedicato allo studio approfondito della libreria \glo{D3.js} è sull'implementazione della visualizzazione \glo{Scatter Plot Matrix} senza però la possibilità di personalizzazione. \textbf{[aggiungere riferimenti agli UC]}
\end{itemize} 
...
\item \textbf{08/02/2020 - 18/02/2020}: il secondo periodo ha data fissata per il 15, il team s'impegnerà a terminare i lavori avviati nel periodo precedente. Inoltre l'obbiettivo è terminare il primo incremento previsto per il \textit{Proof of Concept}.
