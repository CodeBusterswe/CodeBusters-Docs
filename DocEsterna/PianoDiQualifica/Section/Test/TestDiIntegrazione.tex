...
\textbf{TI1} & 
Verificare che il collegamento con il \glo{database} avvenga correttamente. & 
NI\\

\textbf{TI2} & 
Verificare che tutti i \glo{dataset} presenti nel \glo{database} siano raggiungibili. & 
NI\\
...
\textbf{TI4} & 
Verificare che la chiusura del collegamento con il \glo{database} avvenga correttamente. & 
NI\\
