...
\textbf{TS1F3.2} & L'applicazione deve fornire la visualizzazione \glo{Scatter plot Matrix}. Verificare che:
					...
					\end{itemize}	
				  & NI \\
\textbf{TS1F3.3} & L'applicazione deve fornire la visualizzazione \glo{Heat Map} e permettere di riordina i punti. Verificare che:
					\begin{itemize}
...
\label{testSistema}
\end{longtable}
Come si può notare lo stato di tutti i test è NI ("non implementato"). L'implementazione dei test e i loro risultati saranno oggetto della prossima verisone del \PdQv.
