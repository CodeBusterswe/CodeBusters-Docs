...
\textbf{TS1F16} & 
L'utente deve poter scegliere la visualizzazione \glo{\textit{Scatter Plot Matrix}} con un \glo{dataset} di al massimo 5 dimensioni. & 
NI\\
...
\textbf{TS1F17.1} & 
In un \textit{Heat Map} l'utente deve poter ordinare i punti in modo da evidenziare le strutture presenti e applicare un \glo{dendrogramma} ai bordi del grafico. & 
NI\\
