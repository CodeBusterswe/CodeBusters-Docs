...
\end{description}
In questa prima versione delle \NdP si tratta la struttura del solo \glo{repository} CodeBusters-Docs. 
...
\begin{itemize}
	\item \textbf{DocEsterna}: contiene l'\AdR{}, il \PdP{}, il \PdQ{}, il \Glossariov, i \textit{verbali esterni};
	\item \textbf{DocInterna}: contiene lo \SdF{}, le \NdPv{}, i \textit{verbali interni};
