...
\begin{longtable}{C{1.5cm} | C{4.5cm} C{5.5cm} C{4.5cm}}
		...
		$1 - \frac{Number of changed + Number of deleted + Number of added}{Total number of initial requirements} \cdot 100$ \\
		\textbf{MPC4} &
		Satisfied obligatory requirements (SOR) &
		Descrive se il gruppo ha soddisfatto i requisiti obbligatori o meno. &
		$\frac{Number of requirements satisfied}{Total number of requirements} \cdot 100$
