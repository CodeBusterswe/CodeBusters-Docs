...
\begin{itemize}
\item Utilizzo di \glo{Java} e di \glo{Angular} per lo sviluppo della parte di \glo{back-end} e di \glo{front-end} della componente web del sistema;
...
\item Nel capitolato si tratta l'argomento del \glo{machine learning}, molto interessante e che potrebbe risultare utile in altri ambiti e in futuro;
