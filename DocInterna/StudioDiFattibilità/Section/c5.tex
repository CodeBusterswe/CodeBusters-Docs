...
Ogni unità (che può essere un robot, un muletto o un'auto a guida automatica) ha un punto di partenza nella mappa e una lista di \glo{\textit{Point Of Interest}} (POI) che deve raggiungere.
...
\begin{itemize}
\item Node.js per la parte di back-end e \glo{React.js} o \glo{Next.js}  per lo sviluppo di front-end che permettono di creare una SPA (\textit{Single Page Application}) ;
