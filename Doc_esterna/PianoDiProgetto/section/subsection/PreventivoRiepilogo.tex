...
\begin{figure}[!htb]
   \begin{minipage}{0.48\textwidth}
     \centering
     \includegraphics[width=1.3\linewidth]{Images/PO-OreTotali}
     \caption{\parbox{9cm}{Ripartizione oraria totale per ciascun membro}}
   \end{minipage}\hspace{3cm}
   \begin{minipage}{0.4\textwidth}
     \centering
     \includegraphics[width=.7\linewidth]{Images/PE-OreTotali}
     \caption{\parbox{4.5cm}{Ripartizione ore totali}}
   \end{minipage}
\end{figure}
...
\begin{figure}[!htb]
   \begin{minipage}{0.48\textwidth}
     \centering
     \includegraphics[width=1.3\linewidth]{Images/PO-OreRendicontate}
     \caption{\parbox{9cm}{Ripartizione delle ore rendicontate per ciascun membro}}
   \end{minipage}\hspace{3cm}
   \begin{minipage}{0.4\textwidth}
     \centering
     \includegraphics[width=.7\linewidth]{Images/PE-OreRendicontate}
     \caption{\parbox{4.5cm}{Ripartizione ore ore rendicontate}}
   \end{minipage}
\end{figure}
