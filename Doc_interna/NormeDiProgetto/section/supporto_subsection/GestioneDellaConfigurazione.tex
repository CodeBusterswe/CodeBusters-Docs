...
Per gestire le versioni è stato deciso di utilizzare un \glo{version control system (VCS) distribuito} \glo{Git}. 
...
\begin{itemize}
	...
	\item possibilità di creare diversi flussi di lavoro (\glo{branch}) in cui lavorare a documenti differenti;
...
\begin{itemize}
	...
	\item rami derivanti dal \textit{develop} con nomi parlanti, ognuno dedicato alla stesura di uno specifico documento (l'idea fondante è quella del \glo{Git feature branch workflow}).
\end{itemize}
