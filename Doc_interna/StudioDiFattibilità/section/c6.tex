...
Nel caso dell'utilizzo di servizi che richiedano lo sviluppo di codice è vincolato l'uso del linguaggio \glo{NodeJS};
\item \glo{DynamoDB} come database NoSQL per il salvataggio delle classifiche e informazioni a supporto dell'applicativo; 
