...
\paragraph{Obiettivi}
\begin{itemize}
\item Implementazione della visualizzazione \glo{Adjacency Matrix} \textbf{[UC7.2]};
...
\paragraph{Obiettivi}
\begin{itemize}
\item Implementazione della visualizzazione \glo{Force Field} \textbf{[UC7.1]};
...
\paragraph{Obiettivi}
\begin{itemize}
\item Implementazione della visualizzazione \glo{Proiezione Lineare Multi Asse} e \glo{HeatMap} \textbf{[U6.2, UC6.3]};
