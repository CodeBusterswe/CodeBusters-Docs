...
\begin{itemize}
	...
	\item \textbf{B}: cresce al raggiungimento degli obiettivi degli incrementi pianificati nel \PdPv{v4.0.0-1.8}. 
\end{itemize}
...
\textbf{Versionamento del software}\\
...
\textbf{Sistemi software utilizzati}\\
...
\begin{itemize}
	...
	\item Ramo develop in cui effettuare periodicamente il \glo{merge} dai vari rami figli;
