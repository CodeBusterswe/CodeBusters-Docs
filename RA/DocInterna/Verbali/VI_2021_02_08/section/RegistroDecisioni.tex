...
verificare le singole componenti del prodotto attraverso il \glo{framework} \textit{\glo{Jest}}.\\
Interno-7.8 & Deve essere effettuata l'analisi del codice prodotto attraverso la libreria \textit{\glo{EsLint}}.\\
