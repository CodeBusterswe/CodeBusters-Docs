\subsubsection{UC5.1 - Selezione Scatter Plot Matrix}
\begin{itemize}
	...
	\item \textbf{Postcondizioni}: Viene mostrata la visualizzazione \glo{\textit{Scatter Plot Matrix}} scelta dall'utente, con possibilità di personalizzazione [UC6.1];
