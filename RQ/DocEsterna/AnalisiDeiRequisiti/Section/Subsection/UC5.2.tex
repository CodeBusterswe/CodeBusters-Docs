\subsubsection{UC5.2 - Selezione Adjacency Matrix}
\begin{itemize}
	...
	\item \textbf{Postcondizioni}: Viene mostrata la visualizzazione \glo{\textit{Adjacency Matrix}} scelta dall'utente, con possibilità di personalizzazione [UC6.2];
