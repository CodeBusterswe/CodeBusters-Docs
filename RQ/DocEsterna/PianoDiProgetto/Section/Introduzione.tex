...
Per evitare ambiguità relative alle terminologie utilizzate, è stato compilato il \Glossariov{v3.0.0-1.7}. In questo documento sono riportati tutti i termini di particolare importanza e con un significato particolare. Questi termini sono evidenziati da una 'G' ad apice.
