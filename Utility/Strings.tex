% info generali 
\newcommand{\NomeProgetto}{\textit{HD Viz: visualizzazione di dati multidimensionali}}
...
% proponenti
\newcommand{\Proponente}{\textit{Azienda proponente}}
...
\newcommand{\SH}{Safdari Houssaine}
